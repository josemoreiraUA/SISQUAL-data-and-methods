...
@router.get("/{client_id}/models/sizing")
def get_client_models(client_id: str, db: Session = Depends(get_db)):
    client_models = crud.get_client_models(db, client_id, TypeForecast.Sizing)
...
@router.get("/{client_id}/models/customer/flow/and/sizing")
def get_client_models(client_id: str, db: Session = Depends(get_db)):
    client_models = crud.get_client_models(db, client_id, TypeForecast.CustomerFlowAndSizing)
...
@router.get("/{client_id}/models/customer/flow")
def get_client_models(client_id: str, db: Session = Depends(get_db)):
    client_models = crud.get_client_models(db, client_id, TypeForecast.CustomerFlow)
