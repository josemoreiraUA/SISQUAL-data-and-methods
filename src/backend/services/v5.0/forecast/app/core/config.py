...
class Settings(BaseSettings):
    ...
    MODELS_DIR: str = ROOT_DIR + '\\train_a_model\\app\\models\\ml\\'

    # database information
    DATABASE_NAME: str = 'sql_app.db'
    SQLALCHEMY_DATABASE_URI: str = 'sqlite:///' + ROOT_DIR + '\\train_a_model\\app\\' + DATABASE_NAME
    ...
    BACKEND_CORS_ORIGIN_REGEX: Optional[str] = "http://.+:3000"
