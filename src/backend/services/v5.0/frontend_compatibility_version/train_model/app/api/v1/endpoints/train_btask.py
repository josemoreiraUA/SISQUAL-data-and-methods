...
def model_details_to_html(
    ...
    if model_in_db.type == ForecastModels.MLPRegressor or model_in_db.type == ForecastModels.MLPRegressor2:
        html += '<tr>'
...
def create_html_report(
    ...
    elif model_in_db.type == ForecastModels.MLPRegressor2:
        d_metrics = {}
...
def switch(model_type: str, params: TrainIn, task_id: int) -> Union[dict, None]:
    ...
    if model_type == ForecastModels.MLPRegressor2:
        return train_mlp_multivariate(params, task_id)        
    elif ForecastModels.MLPRegressor.value == model_type:
...
def train_model(db: Session, client_pkey: int, model_type: str, params: TrainIn, task_id: int) -> bool:
    ...
    try:
        ...
        if train_output != None:
            ...
            if model_type == ForecastModels.MLPRegressor or model_type == ForecastModels.MLPRegressor2:
